...
const MagasinProduction = () => {
    ...
    const fetchMagasinProduction = async () => {
      if (selectedModel) {
        try {
          ...
          console.error("Error fetching MagasinProduction data:", error);
        }
      }
    };
  ...
  const handleChange = async (direction, type) => {
    ...
    try {
      ...
      console.error("Error updating MagasinProduction data:", error);
    } finally {
  ...
  return (
    <div className="ml-[19%] pt-[6rem]">
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-semibold">Magasin</h2>
